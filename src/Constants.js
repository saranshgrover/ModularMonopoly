...
/*const BuildingPrices = {
   /* Dark Purples */
    /*ID_1 = [0, 2, 10, 30, 90, 160, 250],
    ID_3 = [0, 4, 20, 60, 180, 320, 450],

//     /* Light Blues */
//     ID_6 = [0, 6, 30, 90, 270, 400, 550],
//     ID_8 = [0, 6, 30, 90, 270, 400, 550],
//     ID_9 = [0, 8, 40, 100, 300, 450, 600],

//     /* Purples */
//     ID_11 = [0, 10, 50, 150, 450, 625, 750],
//     ID_13 = [0, 10, 50, 150, 450, 625, 750],
//     ID_14 = [0, 12, 60, 180, 500, 700, 900],

//     /* Oranges */
//     ID_16 = [0, 14, 70, 200, 550, 750, 950],
//     ID_18 = [0, 14, 70, 200, 550, 750, 950],
//     ID_19 = [0, 16, 80, 220, 600, 800, 1000],

//     /* Yellows */
//     ID_21 = [0, 24, 120, 360, 850, 1025, 1200],
//     ID_23 = [0, 22, 110, 330, 800, 975, 1150],
//     ID_24 = [0, 22, 110, 330, 800, 975, 1150],

//     /* Reds */
//     ID_26 = [0, 20, 100, 300, 750, 950, 1100],
//     ID_27 = [0, 18, 90, 250, 700, 875, 1050],
//     ID_29 = [0, 18, 90, 250, 700, 875, 1050],

//     /* Dark Blues */
//     ID_31 = [0, 50, 200, 600, 1400, 1700, 2000],
//     ID_33 = [0, 35, 175, 500, 1100, 1300, 1500],

//     /* Greens */
//     ID_36 = [0, 28, 150, 450, 1000, 1200, 1400],
//     ID_38 = [0, 26, 130, 390, 900, 1100, 1275],
//     ID_39 = [0, 26, 130, 390, 900, 1100, 1275],
